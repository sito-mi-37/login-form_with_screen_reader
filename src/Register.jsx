        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p
              id="pwdnote"
              className={
                !validPwd && pwd && pwdFocus ? "instruction" : "offscreen"
              }
            >
              <FontAwesomeIcon icon={faInfoCircle} />
              8 to 24 characters.
            ...
            <p
              id="confirmnote"
              className={
                !validMatchPwd && matchPwdFocus ? "instructions" : "offscreen"
              }
            >
              <FontAwesomeIcon icon={faInfoCircle} />
            ...
            <button
              disabled={
                !validName || !validMatchPwd || !validPwd ? true : false
              }
            >
              Sign up
            </button>
